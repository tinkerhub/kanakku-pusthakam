...
export const openApiPaths = [
  ...
  "/api/v1/admin/makerspace/{makerspace_id}/email-layout",
  ...
  "/api/v1/admin/makerspace/{makerspace_id}/email-templates/{key}",
  "/api/v1/admin/makerspace/{makerspace_id}/email-templates/{key}/preview",
